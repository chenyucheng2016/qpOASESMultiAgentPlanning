										...
										)
{
	...
	/* NOTE: Internal MPC-aware Riccati code removed - ADMM solves Riccati externally
	 * with full ADMM-augmented gradient (tracking + collision coupling terms).
	 * We pass the external Riccati solution as warm start to init(). */
