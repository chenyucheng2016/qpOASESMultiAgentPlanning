...
The values below are pre-provenance development evidence. Protocol v4 must
reproduce them with recorded shared-front-end and failure-artifact provenance
before submission.
...
\begin{table}[t]
\caption{Development CSDO evidence (\CSDOCases\ cases; v4 rerun pending).}
\label{tab:csdo}
\centering
\begin{tabular}{lcc}
\toprule
