...
the search artifact is locally conflicted. On shared successes, median path
length is \TurboSharedPathMedianMeters~m for \method\ and
\CSDOSharedPathMedianMeters~m for CSDO, only a
\SharedPathReductionPercent\% reduction. We therefore make no broad path
quality or reduced-conservatism claim from this suite.
