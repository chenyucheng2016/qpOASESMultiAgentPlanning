...
case_manifest="benchmarks/instances/csdo/five_agent_evaluation/evaluation_manifest.csv"
result_root="build-ral-wsl/results/csdo_ral/evaluation_five_agent_${git_commit:0:7}"
...
runner_args=(
  ...
  --protocol-id "csdo_five_agent_evaluation_v3"
